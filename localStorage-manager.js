    ...
    saveAnalysisData: function(analysisData) {
        try {
            ...
            const storageObject = {
                ...
                nonFollowers: analysisData.nonFollowers || [],
                fans: analysisData.fans || [],
                totalFollowers: (analysisData.followers || []).length,
                totalFollowing: (analysisData.following || []).length,
                totalNonFollowers: (analysisData.nonFollowers || []).length,
                totalFans: (analysisData.fans || []).length,
